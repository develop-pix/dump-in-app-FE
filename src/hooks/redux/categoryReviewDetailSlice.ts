...
export const categoryReviewDetailSlice = createSlice({
    name: 'categoryReviewDetail',
    initialState,
    reducers: {
        setCategoryReview(state, action) {
...
export const { setCategoryReview } = categoryReviewDetailSlice.actions;

export default categoryReviewDetailSlice.reducer;
