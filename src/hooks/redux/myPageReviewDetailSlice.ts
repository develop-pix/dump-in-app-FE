...
export const myPageReviewDetailSlice = createSlice({
    name: 'myPageReviewDetail',
    initialState,
    reducers: {
        setMyPageReview(state, action) {
...
export const { setMyPageReview } = myPageReviewDetailSlice.actions;

export default myPageReviewDetailSlice.reducer;
