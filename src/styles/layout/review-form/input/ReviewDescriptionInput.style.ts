...
export const ReviewDescriptionTextInput = styled.TextInput<{
    ...
    line-height: 16px;
    padding-top: ${props => (props.platform === 'ios' ? '15px' : props.platform === 'android' ? '10px' : null)};
    padding-bottom: ${props => (props.platform === 'ios' ? '15px' : props.platform === 'android' ? '7px' : null)};
    padding-left: 10px;
    padding-right: 10px;
`;
